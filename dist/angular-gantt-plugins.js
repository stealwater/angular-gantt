/*!
 * Project: angular-gantt v2.0.0-rc.1-fixed - Gantt chart component for AngularJS
...
var GanttColumnsManager = exports.GanttColumnsManager = function () {
    ...
    (0, _createClass3.default)(GanttColumnsManager, [{
        ...
        value: function getHeaderScale(header) {
            ...
            if (['millisecond', 'second', 'minute', 'hour', 'day', 'week', 'month', 'quarter', 'year'].some(function (ele) {
                return scale.includes(ele);
            }) !== true) {
                scale = 'day';
            }
            return scale;
...
var _angularUiTree = __webpack_require__(262);
...
var _ElementQueries = __webpack_require__(263);

var _ElementQueries2 = _interopRequireDefault(_ElementQueries);

var _ResizeSensor = __webpack_require__(264);
